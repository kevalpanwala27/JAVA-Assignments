...
public class ASSIGNMENT_5 {
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader fin = new BufferedReader(new FileReader("/Users/kevalpanwala/Desktop/student_1.txt"));
        ...
        if(id_ >= 1 && id_ <= 3)
            arr.set(id_, s_);
        PrintWriter fout = new PrintWriter(new FileWriter("/Users/kevalpanwala/Desktop/student_1.txt"));
