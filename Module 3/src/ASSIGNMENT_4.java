...
public class ASSIGNMENT_4 {
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream fin = new FileInputStream("/Users/kevalpanwala/Desktop/student.txt");
        ...
        if (choice == 2) {
            ...
            if (id_ >= 1 && id_ <= 3)
                arr.set(id_, s_);
            s = "";
            FileOutputStream fout = new FileOutputStream("/Users/kevalpanwala/Desktop/student.txt");
